      ...
      <header className="App-header">
        ...
        <div>
          ...
          <div style={{ margin: "50px 0" }}>
            ...
            використанням Magento 2 Практичне завдання: Розробити модуль з
            новинами на Magento 2. Основні вимоги: Сайт має бути побудований на
            основі системі Magento 2 (https://devdocs.magento.com) Реалізувати
            наступний функціонал: Створення схеми модулю Створення бази даних
            Створення модулю Інтерактивна адмін панель Створення, оновлення,
            видалення подій Список створених модулів
          </div>
          <div style={{ margin: "50px 0" }}>
